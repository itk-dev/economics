 ...
 */
final class Version20230621165310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE issue ADD project_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_12AD233E166D1F9C ON issue');
        $this->addSql('ALTER TABLE issue DROP project_id');
    }
}
